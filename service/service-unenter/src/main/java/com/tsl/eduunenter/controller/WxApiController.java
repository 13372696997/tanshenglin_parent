...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            //1 微信点击确认后会返回code值，获取code值，临时票据，类似于验证码
            ...
            throw new tanShengLinException(20001,"登录失败");
        }
    }
...
//                "connect/qrconnect?appid="+ ConstantWxUtils.WX_OPEN_APP_ID+"&response_type=code";
        ...
        String redirectUrl = ConstanWxUtils.WX_OPEN_REDIRECT_URL;
        try {
        ...
        String url = String.format(
                baseUrl,
                ConstanWxUtils.WX_OPEN_APP_ID,//appid这个值
                redirectUrl,//redirect_uri这个值
                "atguigu"//state这个值
        );
